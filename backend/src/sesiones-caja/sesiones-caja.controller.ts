...
export class SesionesCajaController {
  ...
  @Get('estado')
  @ApiOperation({ summary: 'Estado actual por taquilla (abierta/cerrada + totales sesión en curso)' })
  estadoTaquillas() {
    return this.service.estadoTaquillas();
  }

  @Get('periodos')
  @ApiOperation({ summary: 'Lista de períodos (cierres cerrados + sesión abierta)' })
  periodos() {
